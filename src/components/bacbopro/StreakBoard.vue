...
<template>
  <section
    ...
    class="rounded-lg border border-bbp-border bg-bbp-panel p-4"
  >
    <h2 class="text-center text-lg font-bold tracking-[0.15em] text-gray-300">
      TABLERO DE RACHAS
    </h2>
    <div class="bbp-scroll mt-4 overflow-x-auto">
      <div class="mx-auto flex w-fit items-start gap-1.5 sm:gap-2 md:gap-3 lg:gap-4">
