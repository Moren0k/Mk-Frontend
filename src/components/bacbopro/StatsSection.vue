...
<template>
  <section
    ...
    class="grid w-full min-w-0 grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2"
  >
    <div
      v-if="loading"
      class="col-span-full min-w-0 rounded-lg border border-bbp-border bg-bbp-panel p-3 sm:p-4"
    >
    ...
    <template v-else>
      <div
        ...
        :key="block.title"
        class="min-w-0 rounded-lg border border-bbp-border bg-bbp-panel p-3 sm:p-4"
      >
