...
<template>
  <header class="sticky top-0 z-20 border-b border-bbp-border bg-bbp-bg">
    <div
      class="mx-auto flex w-full max-w-[1600px] flex-wrap items-center justify-between gap-x-6 gap-y-2 px-4 py-3.5 sm:px-6 sm:py-4"
    >
      <div class="flex min-w-0 items-center gap-3">
        ...
        <h1
          class="text-xl font-black tracking-[0.3em] text-gray-100 sm:text-2xl sm:tracking-[0.35em] lg:text-3xl"
        >
          MKBACBO
        </h1>
      </div>
      <div class="flex min-w-0 flex-wrap items-center gap-2 sm:gap-3">
        <StatusBadge text="CASINO SYNC: ACTIVO" variant="sync" />
